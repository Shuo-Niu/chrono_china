...
FREEZE_PATH = QA_DIR / "phase1_3_1_input_freeze.json"
...
GROUP_SPECS: tuple[tuple[str, tuple[str, ...]], ...] = (
    ...
    (
        ...
        (
            "data/qa/phase1_3_temporal_context_qa.json",
            "data/qa/phase1_3_temporal_context_sources.md",
        ),
    ),
    (
        "marker_alignment_qa",
    ...
    ("user_mode_screenshot_baseline", ("artifacts/phase1_3/*.png",)),
)
...
def capture() -> dict[str, Any]:
    ...
    result = {
        "phase": "1.3.1",
        "purpose": "immutable inputs for MVP Usability Freeze",
