...
FREEZE_PATH = QA_DIR / "phase1_2_2_input_freeze.json"

GROUP_SPECS: tuple[tuple[str, tuple[str, ...]], ...] = (
    (
        "canonical_historical_sources",
        (
            "data/raw/tgaz_index/**/*",
...
def capture() -> dict[str, Any]:
    ...
    result = {
        "phase": "1.2.2",
        "purpose": "immutable inputs for Marker Coordinate Alignment Fix",
